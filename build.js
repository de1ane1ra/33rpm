...
const art_path = "./public/src/res/img/art-comp";
...
const t__pg__showcase = function(image_path) {
    return (
        `<!DOCTYPE html>
        <html lang="en">
            <head>
            ...
            <body>
                ...
                <section>${art_names.map(art_name => `<figure><a href="./${image_path}/${art_name}" rel="noopener noreferrer" target="_blank"><img src="./${image_path}/${art_name}" loading="lazy" /></a></figure>`).join('')}</section>
...
write_html_to_file('./public', 'index.html', t__pg__showcase("./src/res/img/art-comp"));
